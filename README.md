...
### Proposed solution
I am going to create an application that helps Hassan organize his perfumes in the form of an inventory. On opening the application, there would be a feature that informs Hassan on the recommended perfume to use that particular day. This application will also be only accessible to Hassan.
